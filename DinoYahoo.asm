...
desenhaPersonagens:
	...
	; --------- JOGADOR UM
	load r0, jogador
	loadn r3, #256; jogador um será rosa

	loadn r1, #1003 ; posição das orelhinhas
	add r1, r1, r0
	dec r1
	...
	loadn r1, #1078 ; posição do corpo
	add r1, r1, r0
	...
	loadn r1, #1119 ; posição das patinhas
	add r1, r1, r0
...
apagarPersonagens:
	...
	loadn r1, #1078 ; posição da linha do corpo
	add r1, r1, r0
	...
	loadn r1, #1119 ; posição das patas
	add r1, r1, r0
